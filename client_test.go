...
func TestScrapeRequest_MarshalJSON(t *testing.T) {
	tests := map[string]struct {
		...
		"url is empty": {
			...
			nil,
			"GET",
			"{\"url\":\"\",\"geo\":\"test-proxy\",\"method\":\"GET\",\"headers\":[]}",
		},
		"proxy is empty": {
			"https://test",
			"",
			nil,
			"GET",
			"{\"url\":\"https://test\",\"geo\":\"\",\"method\":\"GET\",\"headers\":[]}",
		},
		"method is empty": {
			"https://test",
			"test-proxy",
			nil,
			"",
			"{\"url\":\"https://test\",\"geo\":\"test-proxy\",\"method\":\"\",\"headers\":[]}",
		},
		"headers is nil": {
			"https://test",
			"test-proxy",
			nil,
			"GET",
			"{\"url\":\"https://test\",\"geo\":\"test-proxy\",\"method\":\"GET\",\"headers\":[]}",
		},
		"headers has one element": {
			...
			"GET",
			"{\"url\":\"https://test\",\"geo\":\"test-proxy\",\"method\":\"GET\",\"headers\":[\"test-header: test-value\"]}",
		},
		"headers has multiple elements": {
			...
			"GET",
			"{\"url\":\"https://test\",\"geo\":\"test-proxy\",\"method\":\"GET\",\"headers\":[\"test-header: test-value\",\"test-header2: test-value2\",\"test-header3: test-value3\"]}",
		},
	}
